 ...
 * @since 1.2
 */
public class STreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, java.io.Serializable {
     ...
     * into the map that violates this constraint, the <tt>put(Object key,
     ...
     * <tt>null</tt>, the {@linkplain Comparable natural ordering} of the keys
     * will be used.
     */
    public STreeMap(Comparator<? super K> comparator) {
     ...
     */
    public STreeMap(Map<? extends K, ? extends V> m) {
        comparator = null;
        putAll(m);
    }
     ...
     * @throws NullPointerException if the specified map is null
     */
    public STreeMap(SortedMap<K, ? extends V> m) {
     ...
     * specified map contains a null key and this map does not permit null keys
     */
...
//                }
     ...
     */
    public Object clone() {
        STreeMap<K, V> clone = null;
        try {
            clone = (STreeMap<K, V>) super.clone();
     ...
     * null and this map uses natural ordering, or its comparator does not
     * permit null keys
    ...
    /**
     * @throws ClassCastException {@inheritDoc}
     * @throws NullPointerException if <tt>toKey</tt> is null and this map uses
    ...
    /**
     * @throws ClassCastException {@inheritDoc}
     * @throws NullPointerException if <tt>fromKey</tt> is null and this map
     * uses natural ordering, or its comparator does not permit null keys
     * @throws IllegalArgumentException {@inheritDoc}
     * @since 1.6
     */
    ...
    class Values extends AbstractCollection<V> {
        ...
        public int size() {
            return STreeMap.this.size();
        }

        public boolean contains(Object o) {
            return STreeMap.this.containsValue(o);
        }
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
        ...
        public Iterator<E> iterator() {
            if (m instanceof STreeMap) {
                return ((STreeMap<E, Object>) m).keyIterator();
            } else {
                return (Iterator<E>) (((STreeMap.NavigableSubMap) m).keyIterator());
            }
        }

        public Iterator<E> descendingIterator() {
            if (m instanceof STreeMap) {
                return ((STreeMap<E, Object>) m).descendingKeyIterator();
            } else {
                return (Iterator<E>) (((STreeMap.NavigableSubMap) m).descendingKeyIterator());
            }
        }
     ...
     */
    static <K, V> Map.Entry<K, V> exportEntry(STreeMap.Entry<K, V> e) {
     ...
     */
    static <K, V> K keyOrNull(STreeMap.Entry<K, V> e) {
    ...
    static abstract class NavigableSubMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, java.io.Serializable {
        ...
        NavigableSubMap(STreeMap<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
            if (!fromStart && !toEnd) {
         ...
         * maps
         */
        final STreeMap.Entry<K, V> absLowest() {
            STreeMap.Entry<K, V> e = (fromStart ? m.getFirstEntry() : (loInclusive ? m.getCeilingEntry(lo) : m.getHigherEntry(lo)));
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final STreeMap.Entry<K, V> absHighest() {
            STreeMap.Entry<K, V> e = (toEnd ? m.getLastEntry() : (hiInclusive ? m.getFloorEntry(hi) : m.getLowerEntry(hi)));
            return (e == null || tooLow(e.key)) ? null : e;
        }

        final STreeMap.Entry<K, V> absCeiling(K key) {
            if (tooLow(key)) {
                return absLowest();
            }
            STreeMap.Entry<K, V> e = m.getCeilingEntry(key);
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final STreeMap.Entry<K, V> absHigher(K key) {
            if (tooLow(key)) {
                return absLowest();
            }
            STreeMap.Entry<K, V> e = m.getHigherEntry(key);
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final STreeMap.Entry<K, V> absFloor(K key) {
            if (tooHigh(key)) {
                return absHighest();
            }
            STreeMap.Entry<K, V> e = m.getFloorEntry(key);
            return (e == null || tooLow(e.key)) ? null : e;
        }

        final STreeMap.Entry<K, V> absLower(K key) {
            if (tooHigh(key)) {
                return absHighest();
            }
            STreeMap.Entry<K, V> e = m.getLowerEntry(key);
            return (e == null || tooLow(e.key)) ? null : e;
        }
         ...
         */
        final STreeMap.Entry<K, V> absHighFence() {
         ...
         */
        final STreeMap.Entry<K, V> absLowFence() {
            return (fromStart ? null : (loInclusive ? m.getLowerEntry(lo) : m.getFloorEntry(lo)));
        }

		// Abstract methods defined in ascending vs descending classes
        // These relay to the appropriate absolute versions
        abstract STreeMap.Entry<K, V> subLowest();

        abstract STreeMap.Entry<K, V> subHighest();

        abstract STreeMap.Entry<K, V> subCeiling(K key);

        abstract STreeMap.Entry<K, V> subHigher(K key);

        abstract STreeMap.Entry<K, V> subFloor(K key);

        abstract STreeMap.Entry<K, V> subLower(K key);
        ...
        public final Map.Entry<K, V> pollFirstEntry() {
            STreeMap.Entry<K, V> e = subLowest();
        ...
        public final Map.Entry<K, V> pollLastEntry() {
            STreeMap.Entry<K, V> e = subHighest();
            Map.Entry<K, V> result = exportEntry(e);
            if (e != null) {
                m.deleteEntry(e);
            }
        ...
        public final NavigableSet<K> navigableKeySet() {
            ...
            return (nksv != null) ? nksv : (navigableKeySetView = new STreeMap.KeySet(this));
        }
        ...
        abstract class EntrySetView extends AbstractSet<Map.Entry<K, V>> {
            ...
            public boolean isEmpty() {
                STreeMap.Entry<K, V> n = absLowest();
            ...
            public boolean contains(Object o) {
                ...
                STreeMap.Entry node = m.getEntry(key);
            ...
            public boolean remove(Object o) {
                ...
                STreeMap.Entry<K, V> node = m.getEntry(key);
        ...
        abstract class SubMapIterator<T> implements Iterator<T> {
            ...
            STreeMap.Entry<K, V> lastReturned;
            STreeMap.Entry<K, V> next;
            final Object fenceKey;
            int expectedModCount;

            SubMapIterator(STreeMap.Entry<K, V> first, STreeMap.Entry<K, V> fence) {
            ...
            final STreeMap.Entry<K, V> nextEntry() {
                STreeMap.Entry<K, V> e = next;
            ...
            final STreeMap.Entry<K, V> prevEntry() {
                STreeMap.Entry<K, V> e = next;
                if (e == null || e.key == fenceKey) {
                    throw new NoSuchElementException();
                }
        ...
        final class SubMapEntryIterator extends SubMapIterator<Map.Entry<K, V>> {
            ...
            SubMapEntryIterator(STreeMap.Entry<K, V> first, STreeMap.Entry<K, V> fence) {
                super(first, fence);
            }
        ...
        final class SubMapKeyIterator extends SubMapIterator<K> {
            ...
            SubMapKeyIterator(STreeMap.Entry<K, V> first, STreeMap.Entry<K, V> fence) {
                super(first, fence);
            }
        ...
        final class DescendingSubMapEntryIterator extends SubMapIterator<Map.Entry<K, V>> {
            ...
            DescendingSubMapEntryIterator(STreeMap.Entry<K, V> last, STreeMap.Entry<K, V> fence) {
                super(last, fence);
            }
        ...
        final class DescendingSubMapKeyIterator extends SubMapIterator<K> {
            ...
            DescendingSubMapKeyIterator(STreeMap.Entry<K, V> last, STreeMap.Entry<K, V> fence) {
                super(last, fence);
            }
    ...
    static final class AscendingSubMap<K, V> extends NavigableSubMap<K, V> {
        ...
        AscendingSubMap(STreeMap<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
        ...
        STreeMap.Entry<K, V> subLowest() {
            return absLowest();
        }

        STreeMap.Entry<K, V> subHighest() {
            return absHighest();
        }

        STreeMap.Entry<K, V> subCeiling(K key) {
            return absCeiling(key);
        }

        STreeMap.Entry<K, V> subHigher(K key) {
            return absHigher(key);
        }

        STreeMap.Entry<K, V> subFloor(K key) {
            return absFloor(key);
        }

        STreeMap.Entry<K, V> subLower(K key) {
            return absLower(key);
        }
    }
    ...
    static final class DescendingSubMap<K, V> extends NavigableSubMap<K, V> {
        ...
        DescendingSubMap(STreeMap<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
            super(m, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
        }
    ...
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V>, java.io.Serializable {
        ...
        private Object readResolve() {
            return new AscendingSubMap(STreeMap.this, fromStart, fromKey, true, toEnd, toKey, false);
        }
     ...
     */
    static <K, V> STreeMap.Entry<K, V> successor(Entry<K, V> t) {
        if (t == null) {
            return null;
     ...
     * (Object) for each key-value mapping represented by the TreeMap. The
     * key-value mappings are emitted in key-order (as determined by the
     * TreeMap's Comparator, or by the keys' natural ordering if the TreeMap has
     * no Comparator).
     */
     ...
     * values read from this stream in serialized form. Exactly one of it and
     * str should be non-null.
     * @param defaultVal if non-null, this default value is used for each value
     * in the map. If null, each value is read from iterator or stream, as
     * described above.
     * @throws IOException propagated from stream reads. This cannot occur if
     * str is null.
